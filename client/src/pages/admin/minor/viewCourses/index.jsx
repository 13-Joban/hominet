...
const updateCourses = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const coursesResponse = await dispatch(getCoursesByType('M'));
  ...
  const columns = React.useMemo(() => [
    ...
    },
    {
      ...
      accessor: 'id',
      Cell: ({ value }) => (
        <Link href={`/admin/minor/viewCourses/${value}`}>
  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex flex-col w-full max-w-4xl mx-auto p-8">
        <div className='mb-4 '>
          <p className='text-red font-medium text-2xl'>Minor Degree Mooc Courses List</p>
        </div>
