...
function EnrolledCourse({ course }) {
  ...
  return (
    <div className="flex flex-col justify-center items-center mx-auto">
      {/* Course Details */}
      <div className="bg-white shadow-md rounded-md p-4 mb-4 md:mr-4 w-full ">
      ...
      {/* Certificate Upload */}
      <div className="bg-white shadow-md rounded-md p-4 w-full md:w-3/5">
        <h2 className="text-xl font-bold mb-2">Upload Course Certificate</h2>

        <div className="mb-4">
          <label htmlFor="file-upload" className="block font-medium text-sm text-gray-700">
            Select File
          </label>
